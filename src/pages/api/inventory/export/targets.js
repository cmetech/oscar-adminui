...
async function handler(req, res) {
  ...
  // Initialize the params object, which will be used to pass query parameters
  const params = datacenter ? { datacenter } : {}

  try {
    const response = await axios.get(`${oscarConfig.MIDDLEWARE_INVENTORY_API_URL}/export/targets`, {
      params: params,
