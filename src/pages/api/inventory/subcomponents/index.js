...
async function handler(req, res) {
  if (req.method === 'GET') {
    ...
    try {
      const response = await axios.get(`${oscarConfig.MIDDLEWARE_INVENTORY_API_URL}/subcomponents`, {
    ...
    try {
      ...
      const response = await axios.post(`${oscarConfig.MIDDLEWARE_INVENTORY_API_URL}/subcomponents`, data, {
        headers: {
    ...
    try {
      ...
      const response = await axios.put(
        `${oscarConfig.MIDDLEWARE_INVENTORY_API_URL}/subcomponents/bulk`,
