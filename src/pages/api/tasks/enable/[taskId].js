// pages/api/tasks/enable/[taskId].js
...
export default async function handler(req, res) {
  ...
  try {
    const response = await axios({
      method: 'POST',
      url: `${oscarConfig.MIDDLEWARE_API_URL}/tasks/enable/${taskId}`,
      headers: {
    ...
    console.error('Error forwarding POST request to enable task', error)
