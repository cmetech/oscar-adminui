...
const ServicesDataGrid = props => {
    ...
    },
    {
      ...
      renderCell: params => {
        ...
        return (
          ...
          >
            <Box sx={{ display: 'flex', flexDirection: 'column' }}>
              <Typography noWrap>{row?.version}</Typography>
            </Box>
          </Box>
        )
      }
    },
    {
      ...
      renderCell: params => {
        ...
        return (
          ...
          >
            <Box sx={{ display: 'flex', flexDirection: 'column' }}>
              <Typography noWrap>{row?.formatted_uptime}</Typography>
            </Box>
          </Box>
        )
      }
  ...
  const handleSearch = value => {
    ...
    const filteredRows = rows.filter(row => {
      ...
      const searchFields = ['service', 'name', 'status']
