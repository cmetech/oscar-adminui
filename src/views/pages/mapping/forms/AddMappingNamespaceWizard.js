...
const steps = [
  {
    ...
    subtitle: 'Add Mapping Namespace Information',
    description: 'Add the the Namespace to which new Mappings can belong '
  },
  {
    title: 'Review',
  ...
  const handleNext = async () => {
    ...
    if (activeStep === steps.length - 1) {
      try {
        ...
        const endpoint = '/api/mappingnamespaces'
          ...
          <Fragment>
            <Grid container spacing={1}>
              <Grid item xs={4}>
                ...
                <Grid item xs={12}>
                  <Typography>
                    Description: <strong>{mappingNamespaceDescription.toUpperCase()}</strong>
                  </Typography>
                </Grid>
              </Grid>
            </Grid>
...
export default AddMappingNamespaceWizard
